...
function About() {
  ...
  return (
    ...
    <div style={profileStyle}>
      <h3>I am a seeker, a life-long leaner, a curious person with a desire to connect and understand</h3>
      ...
      <p>I am a passionate and organized team player with track record of thriving both independently and collaboratively. Currently advancing my skills in web and mobile development through a comprehensive full-time full-stack software engineering bootcamp in-person at Epicodus. With a background in natural resources management and culinary arts, I bring a unique perspective to problem-solving and attention to detail. Excited to leverage my adaptable range of abilities and newly acquired coding skills in a software development role, where I can contribute to innovative solutions.</p>
      <p>When I am not coding, you can look for me in the forest: foraging for mushrooms, hiking to alpine lakes, or nordic skiing depending on the season</p>
      <hr />
      </div>
    </>
  )
